...
const center = { lat: 25.413559, lng: -100.151906 }
            ...
            <form @submit.prevent="submit">
                <div class="space-y-12">
                    ...
                    <div class="border-b border-gray-900/10 pb-6">
                        ...
                        <GoogleMap api-key="AIzaSyBcVtyQT7nuF5IDTvWyxg4VLB74xwzUUVI" mapId="HECHOENSANTIAGO" style="width: 100%; height: 500px" :center="center" :zoom="14">
                    ...
                    <div class="border-b border-gray-900/10 pb-6">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="error" v-if="form.errors.foto1">{{ form.errors.foto2 }}</div>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="error" v-if="form.errors.foto1">{{ form.errors.foto3 }}</div>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="error" v-if="form.errors.foto1">{{ form.errors.foto4 }}</div>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="error" v-if="form.errors.foto1">{{ form.errors.foto5 }}</div>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex items-center justify-center">
                    <progress class="error" v-if="form.progress" :value="form.progress.percentage" max="100">
                        {{ form.progress.percentage }}%
                    </progress>
                    <button :disabled="form.processing" type="submit" class="text-xl rounded-md bg-purple-600 px-6 py-4 font-semibold text-white shadow-sm hover:bg-purple-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Enviar Formulario</button>
                </div>
            </form>
        </div>
